...
// SHA-256 hashes of inline scripts in layout.tsx.
// Hash-based CSP allowlisting because nonce approach doesn't work on Vercel.
// Hashes are stable because script content is hardcoded in src/lib/themeScript.ts.
const THEME_SCRIPT_HASH = "'sha256-NKQrmMd/nbWq2Iv4I0YgtUOgn8XHk35ntdeRQ/aIx5A='";
const HASH_REDIRECT_SCRIPT_HASH = "'sha256-7JK5EK69280EB9sr3m2hUOOs9yEp9MINvulf3kUUSSo='";
...
export function proxy() {
  ...
  const scriptSrc = isDev
    ...
    : `'self' 'wasm-unsafe-eval' ${THEME_SCRIPT_HASH} ${HASH_REDIRECT_SCRIPT_HASH} https://accounts.google.com https://tiptopjar.com`;
