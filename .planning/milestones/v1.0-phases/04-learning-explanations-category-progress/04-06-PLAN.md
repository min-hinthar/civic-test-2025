  ...
  <action>
    ...
    4. **CategoryGrid.tsx** - Compact grid of all categories:
       ...
       - Distinct color per main category: blue (Government), amber (History), emerald (Civics)
         (Note: user said "e.g., green for Civics" -- emerald is a shade of green, chosen to avoid clash with success-500 semantic green. This is a reasonable discretion choice per CONTEXT.md "Category color assignments: Claude's discretion")
  </action>
  <verify>
