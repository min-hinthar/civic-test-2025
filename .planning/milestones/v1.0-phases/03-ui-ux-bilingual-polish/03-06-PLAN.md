...
must_haves:
  truths:
    ...
    - "Pre-test breathing animation runs until user clicks I'm Ready button"
  artifacts:
...
Verify breathing animation (circle scaling) runs continuously until ready is clicked.
...
5. PreTestScreen shows breathing animation that runs until user clicks I'm Ready
...
- PreTestScreen has breathing animation that runs continuously until I'm Ready button is clicked
