 ...
 *
 * Self-contained settings section for social features.
 * Shows opt-in toggle, display name editor, and status.
 * Renders inside SettingsPage as a Card section.
 *
 * Uses Card + CardContent pattern matching other Settings sections.
 */
          ...
          <CardContent>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm text-muted-foreground">
                Sign in to enable social features
              </p>
            </div>
            {showBurmese && (
