...
export const BADGE_DEFINITIONS: BadgeDefinition[] = [
  ...
  },
  {
    id: 'streak-30',
    category: 'streak',
    name: { en: 'Monthly Master', my: '\u1010\u1005\u103A\u101C\u1015\u1010\u103A\u101E\u1030\u101B\u1032' },
    description: {
  ...
  },
  {
    id: 'accuracy-100',
    category: 'accuracy',
    name: { en: 'Perfect Score', my: '\u1021\u1015\u103C\u100A\u1037\u103A\u1021\u1019\u103E\u1010\u103A' },
    description: {
  ...
  },
  {
    ...
    category: 'coverage',
    name: { en: 'Category Champion', my: '\u1021\u1019\u103B\u102D\u102F\u1038\u1021\u1005\u102C\u1038\u1001\u103B\u1014\u103A\u1015\u102E\u101A\u1036' },
    description: {
    ...
    icon: 'Award',
    check: (data) =>
      data.totalCategories > 0 && data.categoriesMastered >= data.totalCategories,
  },
];
