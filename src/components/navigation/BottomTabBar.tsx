          ...
          return (
            ...
            >
              ...
              >
                ...
                />
                <NavLabel en={tab.label.en} my={tab.label.my} isActive={isActive} showBurmese={showBurmese} />
              </motion.div>
            </Link>
          );
        })}
        ...
        {user && (
          ...
          >
            ...
            >
              ...
              <NavLabel en={strings.nav.signOut.en} my={strings.nav.signOut.my} isActive={false} showBurmese={showBurmese} />
            </motion.div>
          </button>
        )}
      </div>
