...
export const aboutContent: AboutContent = {
  ...
  hero: {
    ...
    subtitle: {
      en: 'Born from a community. Built for everyone.',
  ...
  sections: [
    ...
    // 2. Mission
    {
      ...
      paragraphs: [
        ...
        {
          en: 'This app puts everything in your language. Explanations in both English and Burmese. Spaced repetition that adapts to how you learn. A practice interview so you know what to expect on the real day. All of it free, all of it offline-ready, and all of it built with the care that your journey deserves.',
    ...
    // 3. VIA (Volunteers in Asia)
    {
      ...
      paragraphs: [
        ...
        {
          en: 'What made VIA different was its two-way philosophy. In 1977, Clark pioneered bringing Japanese university students to Stanford, proving that cultural exchange works best when it flows in both directions. VIA maintained volunteer positions in Burma and led study tours through Yangon, Mandalay, and Bagan, building bridges between American volunteers and the people of Myanmar.',
          my: 'VIA ကို ထူးခြားစေသည်မှာ ၎င်း၏ နှစ်ဖက်ယဉ်ကျေးမှုဖလှယ်ရေး ဒဿနဖြစ်သည်။ ၁၉၇၇ ခုနှစ်တွင် Clark သည် ဂျပန်တက္ကသိုလ်ကျောင်းသားများကို Stanford သို့ ခေါ်ဆောင်လာခြင်းဖြင့် ယဉ်ကျေးမှုဖလှယ်မှုသည် နှစ်ဖက်စီးဆင်းသောအခါ အကောင်းဆုံးဖြစ်ကြောင်း သက်သေပြခဲ့သည်။ VIA သည် မြန်မာနိုင်ငံတွင် စေတနာ့ဝန်ထမ်းရာထူးများ ထိန်းသိမ်းခဲ့ပြီး ရန်ကုန်၊ မန္တလေးနှင့် ပုဂံတို့ကို လေ့လာရေးခရီးများ ဦးဆောင်ကာ အမေရိကန်စေတနာ့ဝန်ထမ်းများနှင့် မြန်မာပြည်သူများအကြား တံတားများ တည်ဆောက်ခဲ့သည်။',
        },
        {
          en: 'The spirit of VIA lives on in this app. Just as Clark believed that understanding comes from showing up, living alongside, and learning together, we believe that preparing for citizenship is richer when you can do it in the language of your heart.',
          my: 'VIA ၏ စိတ်ဓာတ်သည် ဤအက်ပ်တွင် ဆက်လက်ရှင်သန်နေသည်။ Clark သည် နားလည်မှုသည် ရောက်ရှိခြင်း၊ အတူနေထိုင်ခြင်းနှင့် အတူလေ့လာခြင်းမှ လာသည်ဟု ယုံကြည်ခဲ့သကဲ့သို့ နိုင်ငံသားဖြစ်ရေးအတွက် ပြင်ဆင်ခြင်းသည် သင့်နှလုံးသား၏ ဘာသာစကားဖြင့် လုပ်ဆောင်နိုင်သောအခါ ပိုမိုကြွယ်ဝကြောင်း ကျွန်ုပ်တို့ ယုံကြည်ပါသည်။',
        },
      ],
    },
