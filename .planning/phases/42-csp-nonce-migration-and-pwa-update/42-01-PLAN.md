...
must_haves:
  ...
  artifacts:
    ...
    - path: "app/(public)/auth/page.tsx"
      ...
      contains: "headers"
    - path: "src/views/AuthPage.tsx"
      provides: "Accepts nonce prop and forwards to GoogleOneTapSignIn"
      contains: "nonce"
  key_links:
    - from: "proxy.ts"
      to: "app/layout.tsx"
    ...
    - from: "app/(public)/auth/page.tsx"
      to: "src/views/AuthPage.tsx"
      via: "nonce prop from server wrapper to view component"
      pattern: "nonce="
    - from: "src/views/AuthPage.tsx"
      to: "src/components/GoogleOneTapSignIn.tsx"
      via: "nonce prop forwarded to GoogleOneTapSignIn"
      pattern: "nonce="
    - from: "proxy.ts"
...
<task type="auto">
  ...
  <action>
    ...
    **src/views/AuthPage.tsx** -- Accept and forward the nonce:
